	...
	<?php if ( have_comments() ) : ?>
		...
		<h4 class="comments-title">
			...
			if ( '1' === $comments_number ) {
				...
				printf( esc_html_x( 'One Comment', 'comments title' ), get_the_title() );
			} else {
				printf(
			...
			<nav id="comment-nav-below" class="navigation comment-navigation clear">
				<div class="nav-links">
					...
					<div class="nav-previous">
						<?php previous_comments_link( esc_html__( '&larr; Older Comments' ) ); ?>
					</div>
					<div class="nav-next">
						<?php next_comments_link( esc_html__( 'Newer Comments &rarr;' ) ); ?>
					</div>
